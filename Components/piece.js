AFRAME.registerComponent('piece', {
  ...
  init: function () {
    ...
    if (this.id == 0)
    {
      el.setAttribute('position', '-1 0.2 0');
      el.setAttribute('color', '#0000ff');
      el.setAttribute('radius', '0.35');
    }
    else if (this.id == 1)
    {
      el.setAttribute('position', '-1 0.4 0');
    ...
    {
      el.setAttribute('position', '-1 0.6 0');
      el.setAttribute('color', '#00ff00');
      el.setAttribute('radius', '0.25');
    }
    else
    {
      el.setAttribute('position', '-1 0.8 0');
      el.setAttribute('color', '#ff69b4');
      el.setAttribute('radius', '0.2');
    }
  },

  setPositionFromTower: function(towerID, pieceSlot)
  {
